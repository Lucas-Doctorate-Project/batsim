...
struct MainArguments
{
   ...
   struct EventListDescription
   {
    ...
    bool environmental_footprint_used = false;              //!< True if and only if the SimGrid environmental footprint plugin should be used.
    std::string environmental_footprint_trace_file;         //!< The path to the trace file for the environmental footprint plugin.
